...
class Dinosaur(models.Model):
    ...
    acquired = models.BooleanField(choices=((True, 'Tamed'), (False, 'Breeded')), default=True)
    effectiveness = models.IntegerField(default=0)
    status = models.BooleanField(choices=((True, 'Alive'), (False, 'Dead')), default=True)
    sexe = models.BooleanField(choices=((True, 'Male'), (False, 'Female')), default=True)
